...
export default async function FondPage({
  ...
  const [
    ...
    supabase
      ...
      .select(`
        ...
        tax_regime_detail, investment_quota_note,
  ...
  const detail: FundDetailHF = {
    ...
    tax_regime_detail: (fund as any).tax_regime_detail ?? null,
    investment_quota_note: (fund as any).investment_quota_note ?? null,
