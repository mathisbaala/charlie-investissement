      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <div className="flex gap-2 flex-wrap mb-6">
            {fund.sfdr_article && (
              <span className={`px-2 py-1 rounded text-xs font-medium ${fund.sfdr_article === 9 ? "bg-emerald-100 text-emerald-700" : fund.sfdr_article === 8 ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"}`}>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="flex gap-2 flex-wrap">
            <EligBadge label="PEA" ok={fund.is_pea_eligible} />
            <EligBadge label="Assurance-Vie FR" ok={fund.is_av_eligible} />
            <EligBadge label="PER" ok={fund.is_per_eligible} />
            <EligBadge label="AV Luxembourg" ok={fund.is_av_lux_eligible} />
            {!fund.is_pea_eligible && !fund.is_av_eligible && !fund.is_per_eligible && !fund.is_av_lux_eligible && (
