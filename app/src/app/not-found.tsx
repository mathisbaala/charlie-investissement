  ...
  return (
    <div className="h-full min-h-screen flex items-center justify-center bg-cream px-6">
      <div className="max-w-md text-center">
        <p
          className="text-display-lg text-ink italic mb-2"
        ...
        <Link
          href="/accueil"
          className="inline-block px-4 py-2 rounded-lg bg-accent text-paper text-body font-medium hover:bg-accent/90 transition-colors"
        >
          Retour à l'accueil
        </Link>
      </div>
