...
import {
  ...
  LayoutGrid, Search, TrendingUp, Shield, FileText, Logo, Target, Wallet,
...
function StepIcon({ stepKey, size = 20 }: { stepKey: TourStep["key"]; size?: number }) {
  switch (stepKey) {
    ...
    case "allocation": return <Target size={size} strokeWidth={1.7} />;
    case "assureurs": return <Shield size={size} strokeWidth={1.7} />;
    case "cabinet":   return <Wallet size={size} strokeWidth={1.7} />;
